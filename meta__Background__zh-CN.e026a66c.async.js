...
`},83338:function(I,l){l.Z=`import { Background, BackgroundVariant, FlowPanel, FlowView } from '@ant-design/pro-flow';
...
export default BackgroundDemo;
`},49962:function(I,l){l.Z=`import { FlowView, SwimLaneProps, SwimlaneBackground } from '@ant-design/pro-flow';
import { createStyles } from 'antd-style';
import { memo } from 'react';
...
export default BackgroundDemo;
`},8101:function(I,l){l.Z=`import { CSSProperties } from 'react';
