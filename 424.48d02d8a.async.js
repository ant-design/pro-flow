"use strict";(self.webpackChunk_ant_design_pro_flow=self.webpackChunk_ant_design_pro_flow||[]).push([[424],{76794:function(q,C,n){n.d(C,{T:function(){return s.T}});var S=n(26068),d=n.n(S),s=n(51042),g=n(11527);C.Z=function(R){var l=R.gap,_=l===void 0?10:l,T=R.color,L=T===void 0?"#bac3d4":T;return(0,g.jsx)(s.A,d()(d()({},R),{},{gap:_,color:L}))}},82213:function(q,C,n){n.d(C,{Z:function(){return r}});var S=n(26068),d=n.n(S),s=n(75511),g=n(41109),R=n(37700),l=n(5e3),_=n(50959),T=n(41789),L=n(53649),b=n.n(L),G,v,W,P,F,x,K,z,A,D,H,Q,V,B,E=(0,l.kc)(function(i){var t=i.css;return{groupWrap:t(G||(G=b()([`
    width: 355px;
    height: 614px;
    padding: 0;
    display: flex;
