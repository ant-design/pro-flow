"use strict";(self.webpackChunk_ant_design_pro_flow=self.webpackChunk_ant_design_pro_flow||[]).push([[3268],{1067:function(q,C,n){n.d(C,{T:function(){return s.T}});var S=n(26068),d=n.n(S),s=n(5794),g=n(11527);C.Z=function(R){var l=R.gap,_=l===void 0?10:l,T=R.color,L=T===void 0?"#bac3d4":T;return(0,g.jsx)(s.A,d()(d()({},R),{},{gap:_,color:L}))}},45562:function(q,C,n){n.d(C,{Z:function(){return r}});var S=n(26068),d=n.n(S),s=n(15909),g=n(23628),R=n(56525),l=n(46033),_=n(50959),T=n(67799),L=n(53649),b=n.n(L),G,v,W,P,F,x,K,z,A,D,H,Q,V,B,E=(0,l.kc)(function(i){var t=i.css;return{groupWrap:t(G||(G=b()([`
    width: 355px;
    height: 614px;
    padding: 0;
    display: flex;
